(function() {
	...
	i.register("core.util.browser", function(R) {
		...
		var S = {
			...
			IE8 : /msie 8/.test(L),
			IE9 : /msie 9/.test(L),
			SAFARI : !/chrome\/([\d.]*)/.test(L) && /\/([\d.]*) safari/.test(L),
			CHROME : /chrome\/([\d.]*)/.test(L),
			IPAD : /\(ipad/i.test(L),
			IPHONE : /\(iphone/i.test(L),
			ITOUCH : /\(itouch/i.test(L),
	...
	WB2.Module = {
		loginButton : {
			versions : {
				"1.0" : {
					js : "loginButton{ver}.js?version=20130425",
					css : "/t3/style/css/common/card.css?version=20120327"
				},
				latest : {
					js : "loginButton.js?version=20130425",
		...
		followButton : {
			versions : {
				"1.0" : {
					...
					css : "/t3/style/css/common/card.css?version=20120924"
				},
				latest : {
					js : "followButton.js?version=20121210",
		...
		hoverCard : {
			versions : {
				...
				latest : {
					js : "hoverCard.js?version=20130425",
		...
		selector : {
			versions : {
				...
				latest : {
					js : "selector.js?version=20130506",
		...
		shareRecommend : {
			versions : {
				"1.0" : {
					js : "shareRecommend{ver}.js?version=20121206"
				},
				latest : {
					js : "shareRecommend.js?version=20130425",
		...
		like : {
			versions : {
				"1.0" : {
					js : "like{ver}.js?version=20130507"
				},
				latest : {
					js : "like.js?version=20130507",
					css : "/t4/appstyle/widget/css/praiseButton/praiseButton.css?version=20130104"
				}
			}
		},
		iframeWidget : {
			versions : {
				latest : {
					js : "iframeWidget.js?version=20130315"
				}
			}
		},
		invite : {
			versions : {
				"1.0" : {
					js : "invite{ver}.js?version=20121225"
				},
				latest : {
					js : "invite.js?version=20121225",
		...
		quote : {
			versions : {
				"1.0" : {
					js : "quote{ver}.js?version=20121225"
				},
				latest : {
					js : "quote.js?version=20121225"
				}
			}
		}
	};
	...
	var d = {
		...
		save : function(L) {
			WB2.oauthData = L;
			var M = "access_token=" + (L.access_token || "") + "&refresh_token=" + (L.refresh_token || "") + "&expires_in=" + (L.expires_in || 0) + "&uid=" + (L.uid || "") + "&status="
					+ (L.status || w || -1);
			D.set("weibojs_" + WB2._config.appkey, M, {
				path : "/",
		...
		del : function() {
			WB2.oauthData = {};
			D.remove("weibojs_" + WB2._config.appkey, {
				path : "/",
				domain : document.domain
			})
		}
